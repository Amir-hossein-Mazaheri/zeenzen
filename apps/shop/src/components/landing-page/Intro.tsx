  ...
  return (
    <div className="flex md:flex-row flex-col gap-10 items-center justify-center">
      ...
      <div className="max-w-3xl shrink">
        <h1 className="font-bold md:text-4xl text-center md:text-right md:text-inherit leading-loose text-3xl text-title-black md:mb-9 mb-5">
          یادگیری هیچوقت اینقدر آسون نبوده!
        </h1>
        <p
          data-testid="intro-paragraph"
          className="md:leading-[3rem] leading-[2.5] md:text-xl text-lg text-center md:text-right md:text-inherit font-medium"
        >
